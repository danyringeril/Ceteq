...
public class Condicionales8_DSB {
	...
	public static void main(String[] args) {
		 ...
		 * muestre por pantalla el número en letras (dato cadena) de la 
		 * cara opuesta al resultado obtenido. Nota 1: En las caras 
		 * opuestas de un dado de seis caras están los números: 
		 * 1-6, 2-5 y 3-4. Nota 2: Si el número del dado introducido es 
		 * menor que 1 o mayor que 6, se mostrará el mensaje: “ERROR: 
		 * número incorrecto”.
		 */
