...
//		}
		/*
		 * Condiciones compuestas con operadores logicos AND, OR, NOT, DIFERENTE DE,
		 * IGUALDAD
		 * 
...
//		}
		...
		/*
		 * NOT - ! - Niega una condicion o sentencia/Cambia el valor de true a false y
		 * viceversa !NO
		 */
...
//		}
		...
		/*
		 * IGUALDAD O COMPARACION - == - Revisa o compara el valor para verificar si son
		 * iguales Un solo = significa asignacion de valor hacia una variable Este
		 * operador funciona mejor al comparar valores numericos
		 */
...
//		}
		...
		/*
		 * DIFERENTE DE - != - Devuelve el valor true si la condicion es diferente de lo
...
//		}
		...
		/*
		 * Estructura if else anidado Se utiliza para evaluar distintos "casos" que
		 * puedan presentarse
		 */
...
//		}
		...
		/*
		 * Estructura de desicion SWITCH-CASE Puede ser con tipo de dato String, int,
		 * char, etc Switch case se utiliza más cuando tenemos casos bien definidos y
		 * una variable nos ayuda a evaluarlos facilmente
		 */
