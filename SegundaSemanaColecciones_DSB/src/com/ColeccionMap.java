...
public class ColeccionMap {
	...
	public static void main(String[] args) {
		...
		/*
		 * La interfaz Map asocia o almacena los datos en pares (clave - valor a
		 * almacenar) Las claves no pueden duplicarse
		 */
		...
		/*
		 * Declaracion de un Map y la clase HashMap para almacenar claves de tipo
		...
		/*
		 * Imprimir en la pantalla un solo valor almacenado en una determinada clave
		 */
