...
public class AlumnoService {
	...
	/*Esta clase es donde se le da salida a los datos o incluso entrada de datos, los presentamos
	 * y asi exponemos la funcionalidad del backend.
	 * 
	 * Aqui se generan los endpoints o urls para las peticiones web
	 * que ejecutaran los metodos declarados en esta clase
	 * 
	 * los endpoints se componen de varias partes
	 * primera parte del endpoint se compine por la ip donde se despliega el servidor
	 * en este caso Tomcat y el puerto
	 * http://localhost
	 * Siguiente parte, se compone de las UrlPattern en el archivo
	 * web.xml
	 * http://localhost:8090/nombreProyecto/nombreProyecto
	 * Siguiente parte del endpoint es el nombre o path de la clase
	 * http://localhost:8090/JDBCWEB_DSB/JDBCWEB_DSB/(PathClase)alumnos/PathDelMetodo
	 *  
	 *  Necesitamos una instancia nula de la clase AlumnoDAO para utilizar los metodos
	 */
	
	AlumnoDAO dao = null;
	
	//Comenzamos con la declaracion de los metodos que se ejecutaran a traves de las 
	//peticiones HTTP
