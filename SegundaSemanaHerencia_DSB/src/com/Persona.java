...
public abstract class Persona {
	...
	// La sobrecarga de metodos se podria entender que es tener un método
	// polimorfico
	// o varios metodos con el mismo nombre, pero que van a realizar diferentes
	// acciones
	// gracias a la cantidad de argumentos que soliciten (sobrecarga de argumentos)

	// Creación de un método abstracto - esto obliga a que la clase se vuelva
	// abstracta
